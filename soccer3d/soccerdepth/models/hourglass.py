...
class HourglassNet(nn.Module):
    ...
    def __init__(self, block, num_stacks=2, num_blocks=4, input_nc=3, output_nc=16):
        ...
        for i in range(num_stacks):
            ...
            score.append(nn.Conv2d(ch, output_nc, kernel_size=1, bias=True))
            if i < num_stacks-1:
                fc_.append(nn.Conv2d(ch, ch, kernel_size=1, bias=True))
                score_.append(nn.Conv2d(output_nc, ch, kernel_size=1, bias=True))
